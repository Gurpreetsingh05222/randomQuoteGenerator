const quoteArray = [
  {"author":"Bill Sempf","id":43,"quote":"QA Engineer walks into a bar. Orders a beer. Orders 0 beers. Orders 999999999 beers. Orders a lizard. Orders -1 beers.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/43"},
  
  {"author":"Phil Karlton","id":42,"quote":"There are only two hard things in Computer Science: cache invalidation, naming things and off-by-one errors.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/42"},
  
  {"author":"Jeff Atwood","id":41,"quote":"In software, we rarely have meaningful requirements. Even if we do, the only measure of success that matters is whether our solution solves the customer\u2019s shifting idea of what their problem is.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/41"},
  
  {"author":"Robert Sewell","id":40,"quote":"If Java had true garbage collection, most programs would delete themselves upon execution.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/40"},
  
  {"author":"Gavin Russell Baker","id":39,"quote":"C++ : Where friends have access to your private members.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/39"},
  
  {"author":"Bjarne Stroustrup","id":38,"quote":"In C++ it\u2019s harder to shoot yourself in the foot, but when you do, you blow off your whole leg.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/38"},
  
  {"author":"Alan Kay","id":37,"quote":"Most software today is very much like an Egyptian pyramid with millions of bricks piled on top of each other, with no structural integrity, but just done by brute force and thousands of slaves.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/37"},
  
  {"author":"Larry DeLuca","id":36,"quote":"I\u2019ve noticed lately that the paranoid fear of computers becoming intelligent and taking over the world has almost entirely disappeared from the common culture.  Near as I can tell, this coincides with the release of MS-DOS.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/36"},
  
  {"author":"Mark Gibbs","id":35,"quote":"No matter how slick the demo is in rehearsal, when you do it in front of a live audience, the probability of a flawless presentation is inversely proportional to the number of people watching, raised to the power of the amount of money involved.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/35"},
  
  {"author":"Henry Petroski","id":34,"quote":"The most amazing achievement of the computer software industry is its continuing cancellation of the steady and staggering gains made by the computer hardware industry.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/34"},
  
  {"author":"Jeremy S. Anderson","id":33,"quote":"There are two major products that come out of Berkeley: LSD and UNIX.  We don\u2019t believe this to be a coincidence.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/33"},
  
  {"author":"Sam Ewing","id":32,"quote":"Computers are like bikinis. They save people a lot of guesswork.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/32"},
  
  {"author":"Jamie Zawinski","id":31,"quote":"Linux is only free if your time has no value.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/31"},
  
  {"author":"Dick Brandon","id":30,"quote":"Documentation is like sex; when it's good, it's very, very good, and when it's bad, it's better than nothing.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/30"},
  
  {"author":"Richard Moore","id":29,"quote":"The difference between theory and practice is that in theory, there is no difference between theory and practice.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/29"},
  
  {"author":"Michael Sinz","id":28,"quote":"Programming is like sex: one mistake and you\u2019re providing support for a lifetime.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/28"},
  
  {"author":"Bjarne Stroustrup","id":27,"quote":"There are only two kinds of programming languages: those people always bitch about and those nobody uses.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/27"},
  
  {"author":"Donald Knuth","id":26,"quote":"Beware of bugs in the above code; I have only proved it correct, not tried it. ","permalink":"http://quotes.stormconsultancy.co.uk/quotes/26"},
...
function newQuote() {
	...
	document.getElementById('quote-area').textContent = quoteArray[randomNumber]["quote"];
  document.getElementById('author').textContent = quoteArray[randomNumber]["author"];
...
function randomColor() {
  // make random number
  let randomNum = Math.floor(Math.random() * hexChars.length);
  // catch random hex characters
  let hexCode = hexChars[randomNum];
  return hexCode;
}

//Change page color & text
function applyColor() {
  let hexColor = randomColor();
  container.style.backgroundColor = hexColor;
  console.log(hexColor);
  document.getElementById('quote-display').style.color = hexColor;
}

//Quote and color on new tab/page load
newQuote();